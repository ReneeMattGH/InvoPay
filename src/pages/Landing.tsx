    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-lg gradient-stellar flex items-center justify-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/auth?tab=signup">
            <Button size="sm" className="gradient-stellar text-primary-foreground">
              Get Started
            </Button>
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-28 text-center">
        ...
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold max-w-4xl mx-auto leading-tight animate-slide-up">
          Unlock <span className="gradient-stellar-text">Instant Liquidity</span> from Your Invoices
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 animate-slide-up">
          <Link to="/auth?tab=signup">
            <Button size="lg" className="gradient-stellar text-primary-foreground px-8 glow-cyan">
              Start as Business
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </Link>
          <Link to="/auth?tab=signup&role=investor">
            <Button size="lg" variant="outline" className="px-8 border-primary/30 text-primary hover:bg-primary/10">
              Invest in Pools
            </Button>
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-28">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={f.title} className="glass-card rounded-xl p-6 hover:glow-cyan transition-all duration-300">
